...
const Home = () => {
  ...
  return (
    <div className="home">
      <section></section>
      <h1 class="bg-clip-text text-transparent bg-gradient-to-l from-yellow-500 via-red-400 to-green-500 text-8xl font-bold mb-8 mt-12 text-center animate-bounce">Draw and Guess</h1>      <main>
